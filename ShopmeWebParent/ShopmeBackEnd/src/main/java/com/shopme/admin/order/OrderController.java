...
public class OrderController {
	...
	//
	// ra.addFlashAttribute("message", "The order ID " + order.getId()
	...
	// }
	//
	// private void updateProductDetails(Order order, HttpServletRequest
	// request) {
	// String[] detailIds = request.getParameterValues("detailId");
	// String[] productIds = request.getParameterValues("productId");
	// String[] productPrices = request.getParameterValues("productPrice");
	// String[] productDetailCosts = request
	// .getParameterValues("productDetailCost");
	// String[] quantities = request.getParameterValues("quantity");
	// String[] productSubtotals = request
	// .getParameterValues("productSubtotal");
	// String[] productShipCosts = request
	// .getParameterValues("productShipCost");
	//
	...
	// orderDetail
	// .setProduct(new Product(Integer.parseInt(productIds[i])));
