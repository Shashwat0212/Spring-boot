...
public class ProductController {
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum,
		...
		Page<Product> page = prodService.listByPage(pageNum, sortField, sortDir,
				keyword, categoryId);
	...
	public String saveProduct(Product product,
		...
		ProductSaveHelper.setExistingExtraImageNames(imageIDs, imageNames,
				product);
		ProductSaveHelper.setNewExtraImageNames(extraImageMultiparts, product);
		ProductSaveHelper.setProductDetails(detailIDs, detailNames,
				detailValues, product);
