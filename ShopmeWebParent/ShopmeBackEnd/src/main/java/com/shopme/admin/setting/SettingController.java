...
public class SettingController {
	...
	public String listAll(Model model) {
		...
		List<Currency> listCurrencies = currRepo.findAllByOrderByNameAsc();
	...
	public String savedGeneralSettings(
	...
	private void saveCurrencySymbol(HttpServletRequest request,
		...
		Integer currencyId = Integer
				.parseInt(request.getParameter("CURRENCY_ID"));
		Optional<Currency> findByIdResult = currRepo.findById(currencyId);
	...
	public String saveMailTemplateSettings(HttpServletRequest request,
		...
		ra.addFlashAttribute("message",
				"Mail template settings have been saved");
		return "redirect:/settings#mailTemplates";
	}
	@PostMapping("/settings/save_payment")
	public String savePaymentSetttings(HttpServletRequest request,
			RedirectAttributes ra) {
