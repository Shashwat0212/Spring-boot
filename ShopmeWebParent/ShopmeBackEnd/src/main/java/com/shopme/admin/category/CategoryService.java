...
public class CategoryService {
	...
	private List<Category> listHeirarchicalCategories(
		...
		for (Category rootCategory : rootCategories) {
			...
			Set<Category> children = sortSubCategories(
					rootCategory.getChildren(), sortDir);
	...
	public List<Category> listCategoriesUsedInForm() {
		...
		Iterable<Category> categoriesInDB = categoryRepo
				.findRootCategories(Sort.by("name").ascending());
	...
	public Category get(Integer id) throws CategoryNotFoundException {
		try {
			...
			throw new CategoryNotFoundException(
					"Could not find any category wth ID " + id);
		}
	}
