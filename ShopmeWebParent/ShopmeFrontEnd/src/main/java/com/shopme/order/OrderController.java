...
public class OrderController {
	...
	public String listOrdersByPage(Model model, HttpServletRequest request,
		...
		Page<Order> page = orderService.listForCustomerByPage(customer, pageNum,
				sortField, sortDir, orderKeyword);
	...
	//
	// boolean didCustomerReviewProduct = reviewService
	// .didCustomerReviewProduct(customer, productId);
	...
	// .canCustomerReviewProduct(customer, productId);
