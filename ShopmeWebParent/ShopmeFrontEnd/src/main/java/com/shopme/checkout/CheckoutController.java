...
public class CheckoutController {
	...
	public String showCheckoutPage(Model model, HttpServletRequest request) {
		...
		if (defaultAddress != null) {
			...
			shippingRate = shipService
					.getShippingRateForAddress(defaultAddress);
		} else {
	...
	public String placeOrder(HttpServletRequest request)
		...
		orderService.createOrder(customer, defaultAddress, cartItems,
				paymentMethod, checkoutInfo);
	...
	// JavaMailSenderImpl mailSender = Utility
	// .prepareMailSender(emailSettings);
	...
	// "HH:mm:ss E, dd MMM yyyy");
	// String orderTime = dateFormatter.format(order.getOrderTime());
	//
	// CurrencySettingBag currencySettings = settingService
	// .getCurrencySettings();
	...
	// message = "ERROR: Transaction could not be completed because order
	// information is invalid";
	// }
	// } catch (PayPalApiException e) {
	// message = "ERROR: Transaction failed due to error: "
	// + e.getMessage();
	// }
	//
